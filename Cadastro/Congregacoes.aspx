<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageHome.master" AutoEventWireup="true" CodeFile="Congregacoes.aspx.cs" Inherits="Cadastro_Congregacoes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <fieldset class="fieldsetDefault" style="width:60%">
        <center>
            <asp:TextBox ID="txtNome" runat="server" placeholder="Nome" required CssClass="txt"></asp:TextBox>
            <asp:DropDownList ID="ddlCidade" runat="server" CssClass="ddlDefault"></asp:DropDownList>
            <asp:DropDownList ID="ddlRegiao" runat="server" CssClass="ddlDefault"></asp:DropDownList>
            <asp:TextBox ID="txtCodigoRelatorio" runat="server" placeholder="Código Relatório (Números)" required CssClass="txt"></asp:TextBox>
    ...
    <fieldset class="fieldsetDefault" style="width:60%">
        ...
        <asp:GridView ID="gvIgrejas" runat="server" BackColor="White" BorderColor="#336666" 
